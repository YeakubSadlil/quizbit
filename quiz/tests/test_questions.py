...
def test_questionlist_tokenbucket_throttle(api_client, get_question_list):
    # override default throttling for test purpose
    original_throttle = QuestionListView.throttle_classes
    try:
        QuestionListView.throttle_classes = [QuestionListTestTokenBucketThrottle]
        ...
        QuestionListView.throttle_classes = original_throttle
